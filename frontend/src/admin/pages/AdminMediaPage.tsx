            ...
            <table className="w-full min-w-[680px] text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 dark:border-zinc-800/80 bg-slate-50 dark:bg-zinc-900/50 text-[10px] font-mono uppercase tracking-wider text-slate-600 dark:text-zinc-400">
                  <th className="py-3 px-4 whitespace-nowrap min-w-[220px]">Asset</th>
                  <th className="py-3 px-4 whitespace-nowrap min-w-[130px]">Type / Category</th>
                  <th className="py-3 px-4 whitespace-nowrap min-w-[100px]">Size</th>
                  <th className="py-3 px-4 whitespace-nowrap min-w-[130px]">MIME Type</th>
                ...
                {mediaList.map((media) => {
                  ...
                  return (
                    <tr key={media.id} className="hover:bg-slate-50/80 dark:hover:bg-zinc-900/30 transition-colors">
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        <span className="px-2 py-0.5 rounded text-[10px] font-mono uppercase bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 border border-slate-200 dark:border-zinc-700 shadow-2xs whitespace-nowrap">
                          {media.category}
                        </span>
                      </td>

                      <td className="py-3 px-4 font-mono text-slate-600 dark:text-zinc-400 whitespace-nowrap">
                        {formatBytes(media.size)}
                      </td>

                      <td className="py-3 px-4 font-mono text-slate-500 dark:text-zinc-500 text-[11px] whitespace-nowrap">
                        {media.mimeType}
                      </td>
                      ...
                      <td className="py-3 px-4 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-1.5 shrink-0">
                          <button
                            onClick={() => handleCopyUrl(media.url, media.id)}
                            className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-950 border border-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-300 dark:hover:text-white dark:border-transparent transition-colors cursor-pointer shadow-2xs shrink-0"
                            title="Copy URL"
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-950 border border-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-300 dark:hover:text-white dark:border-transparent transition-colors shadow-2xs shrink-0"
                            title="Open in new tab"
                          >
                            <ExternalLink className="w-3.5 h-3.5" />
                          </a>
                          <button
                            onClick={() => setDeleteTarget({ id: media.id, name: media.originalName || media.filename })}
                            className="p-1.5 rounded-lg bg-slate-100 hover:bg-red-50 text-slate-500 hover:text-red-600 border border-slate-200 hover:border-red-200 dark:bg-red-950/60 dark:hover:bg-red-900 dark:text-red-300 dark:border-transparent transition-colors cursor-pointer shadow-2xs shrink-0"
                            title="Delete Asset"
                          >
                            <Trash2 className="w-3.5 h-3.5" />
                          </button>
