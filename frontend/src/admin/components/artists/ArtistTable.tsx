            ...
            {artists.map((artist) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] font-mono text-slate-400 dark:text-zinc-500">ID: {artist.id}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  {/* 2. Slug Badge */}
                  <td className="py-4 px-6">
                    <span className="inline-block px-2.5 py-1 rounded-md bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-[11px] font-mono text-slate-600 dark:text-zinc-400">
                      ...
                      {(Array.isArray(artist.genres) ? artist.genres : (artist.genres || '').split(',')).map(
                        (g: string, i: number) => {
                          ...
                          return (
                            <span
                              key={i}
                              className="px-2 py-0.5 rounded bg-slate-100 dark:bg-zinc-800/80 text-[10px] font-mono text-slate-600 dark:text-zinc-300 border border-slate-200 dark:border-zinc-700/40"
                            >
                              {tag}
                            </span>
                          );
                  ...
                  {/* 5. Monthly Listeners */}
                  <td className="py-4 px-6 text-right font-mono text-slate-800 dark:text-zinc-300">
