    ...
    <header className="admin-topbar h-14 px-4 lg:px-6 border-b border-slate-200 dark:border-zinc-800/80 bg-white/90 dark:bg-[#08080a]/90 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between transition-colors duration-300">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="lg:hidden p-1.5 rounded-lg text-slate-500 dark:text-zinc-400 hover:text-slate-950 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
        ...
        {title && (
          <div>
            ...
            {subtitle && <p className="text-[11px] text-slate-500 dark:text-zinc-400 hidden sm:block">{subtitle}</p>}
          </div>
        )}
      </div>
