      ...
      <Container className="relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-vexo-red/10 border border-vexo-red/30 text-vexo-red text-xs font-mono font-bold tracking-widest uppercase mb-4 shadow-sm backdrop-blur-md"
          >
        ...
        {/* 3 Packages Grid with Refined Glassmorphism Effect */}
                  ...
                  >
                    ...
                    <div className="p-7 sm:p-8 relative z-20">
                      ...
                      <div className="text-center pt-2 mb-4">
                        <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-wide mb-1.5 flex items-center justify-center gap-2">
                          <span className={isGold ? 'text-red-500' : 'text-zinc-400'}>✦</span>
                          ...
                          {rupeeSymbol && (
                            <span
                              className={`text-xl sm:text-2xl font-bold font-mono ${
                                isGold ? 'text-red-400' : 'text-zinc-400'
                              }`}
                            >
                              {rupeeSymbol}
                            </span>
                        ...
                        <div className="flex items-center justify-center gap-1.5 text-[10px] sm:text-[11px] text-zinc-400 uppercase tracking-widest font-mono">
                          <span
                            className={`w-1.5 h-1.5 rounded-full ${
                              isGold ? 'bg-red-400 animate-pulse' : 'bg-emerald-400'
                            }`}
                          />
                      ...
                      <div className="space-y-6 text-sm">
                        ...
                        <div>
                          ...
                          <ul className="space-y-2 pl-9 text-xs text-zinc-300">
                            {pkg.photography.details.map((item: string, i: number) => (
                              <li key={i} className="flex items-start gap-2">
                                <span className={isGold ? 'text-red-400 font-bold' : 'text-zinc-500 font-bold'}>•</span>
                                <span>{item}</span>
                              </li>
                            ))}
                          </ul>
                          ...
                          >
                            <div
                              className={`w-5 h-5 rounded-md flex items-center justify-center shrink-0 ${
                                isGold ? 'bg-red-500/15 text-red-400' : 'bg-white/10 text-zinc-400'
                              }`}
                            >
                        ...
                        {pkg.platinumExperience && pkg.platinumExperience.length > 0 && (
                          <div className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/10 via-amber-500/[0.02] to-transparent border border-amber-500/25 text-xs">
                            <span className="font-bold text-amber-300 uppercase tracking-wider block mb-2 flex items-center gap-1.5 font-mono">
                              ...
                              <span>Platinum VIP Direction</span>
                            </span>
                            <ul className="space-y-1.5 text-zinc-300 pl-4">
                    ...
                    <div className="p-7 sm:p-8 pt-0 space-y-3 relative z-20">
                      ...
                      <button
                        ...
                        className="w-full py-2.5 px-3 rounded-lg text-xs text-zinc-400 hover:text-emerald-400 hover:bg-emerald-500/10 transition-all flex items-center justify-center gap-1.5 cursor-pointer font-medium"
                      >
