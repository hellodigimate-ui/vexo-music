...
export const adminHomepageRoutes = async (fastify) => {
    // GET /api/admin/homepage
    fastify.get('/homepage', { preHandler: [fastify.authenticate] }, async () => {
    ...
    fastify.put('/homepage', { preHandler: [fastify.authenticate] }, async (request, reply) => {
