...
export const adminMediaRoutes = async (fastify) => {
    // GET /api/admin/media
    fastify.get('/media', { preHandler: [fastify.authenticate] }, async (request) => {
    ...
    fastify.get('/media/:id', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.post('/media/upload', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.post('/media', { preHandler: [fastify.authenticate] }, async (request, reply) => {
        const user = request.adminUser;
    ...
    fastify.delete('/media/:id', { preHandler: [fastify.authenticate] }, async (request, reply) => {
        const user = request.adminUser;
        const { id } = request.params;
