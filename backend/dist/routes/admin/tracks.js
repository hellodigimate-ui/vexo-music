...
export const adminTrackRoutes = async (fastify) => {
    // GET /api/admin/tracks
    fastify.get('/tracks', { preHandler: [fastify.authenticate] }, async (request) => {
    ...
    fastify.get('/tracks/:id', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.put('/tracks/reorder', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.post('/tracks', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    ...
    fastify.put('/tracks/:id', { preHandler: [fastify.authenticate] }, async (request, reply) => {
        const user = request.adminUser;
        const { id } = request.params;
    ...
    fastify.delete('/tracks/:id', { preHandler: [fastify.authenticate] }, async (request, reply) => {
        const user = request.adminUser;
        const { id } = request.params;
        const existing = db.tracks.findById(id);
        if (!existing) {
